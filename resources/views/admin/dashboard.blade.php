                            ...
                            <div class="media">
                                ...
                                <div dir="ltr" class="ml-2">
                                    <input data-plugin="knob" data-width="56" data-height="56" data-linecap=round
                                        data-displayInput=false data-fgColor="#2fa97c" value="56" data-skin="tron"
                                        data-angleOffset="56" data-readOnly=true data-thickness=".17" />
                                </div>
                            </div>
                            <hr>
                            <div class="media">
                                <div class="media-body">
                                    ...
                                    <h5 class="mb-0"> + 12 % <span class="font-size-14 text-muted ml-1">From previous
                                            period</span></h5>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div>
                                            <p class="text-muted"><i class="mdi mdi-circle text-warning mr-1"></i> Twitter
                                            </p>
                                            <h5>$ 1,504</h5>
                                        </div>
                                    </div>
                                            ...
                                            <td>
                                                <div dir="ltr" class="ml-2">
                                                    <input data-plugin="knob" data-width="36" data-height="36"
                                                        data-linecap=round data-displayInput=false data-fgColor="#2fa97c"
                                                        value="56" data-skin="tron" data-angleOffset="36"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div dir="ltr" class="ml-2">
                                                    <input data-plugin="knob" data-width="36" data-height="36"
                                                        data-linecap=round data-displayInput=false data-fgColor="#2fa97c"
                                                        value="42" data-skin="tron" data-angleOffset="36"
                                                        data-readOnly=true data-thickness=".2" />
                                                </div>
                                            </td>
                                        </tr>
