                    ...
                    <div class="float-right d-none d-md-block">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated">
                                ...
                                <a class="dropdown-item" href="{{ route('add.norm') }}">Nuevo</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Listado de Normas / IGA</h4>
                                    ...
                                    @isset($norms)
                                        @foreach ($norms as $norm)
                                            <tr>
                                                ...
                                                <td>{{ $norm->applicable_standard }}</td>
                                                <td>{{ $norm->short_name }}</td>
                                                <td>{{ date('d/m/Y', strtotime($norm->expedition)) }}</td>
                                                <td>{{ isset($norm->notification) ? date('d/m/Y', strtotime($norm->notification)) : '' }}</td>
                                                <td>
    ...
    <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('import.norm') }}" method="POST" enctype="multipart/form-data">
                    @csrf
