...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Login | Sistema de Informes</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            <a href="index.html" class="logo"><img src="assets/images/logo-sag-azul.png" height="100" alt="logo"></a>
                            <h5 class="font-size-16 text-white-50 mb-4">Sistema de Informes</h5>
                        </div>
                    </div>
                </div>
                <!-- end row -->
