        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/logo-sag-azul.png') }}" alt="" height="15">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo-sag-azul.png') }}" alt="" height="50">
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="d-none d-sm-inline-block ml-1">{{ $profileData->name }}</span>
